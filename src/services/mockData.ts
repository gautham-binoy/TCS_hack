...
// Anchor coordinates for the fictional Verdant Institute of Technology EcoCampus
export const CAMPUS_CENTER: [number, number] = [37.4285, -122.1690];

export const mockCampusOverview: CampusOverview = {
  id: 'campus-vit-main',
  name: 'Verdant EcoCampus Twin',
  location: 'Northern California Campus Grounds',
...
export const mockWasteBins: WasteBin[] = [
  { id: 'bin-01', code: 'WB-ENG-EXT-01', category: 'recycle', fillLevel: 42, coordinates: [37.4302, -122.1706], location: 'Science Hall South Entrance', buildingId: 'bldg-eng', status: 'normal', lastCollected: 'Today 06:30' },
  { id: 'bin-02', code: 'WB-ENG-EXT-02', category: 'compost', fillLevel: 65, coordinates: [37.4303, -122.1705], location: 'Science Hall South Entrance', buildingId: 'bldg-eng', status: 'normal', lastCollected: 'Today 06:30' },
  { id: 'bin-03', code: 'WB-ENG-EXT-03', category: 'landfill', fillLevel: 38, coordinates: [37.4304, -122.1704], location: 'Science Hall South Entrance', buildingId: 'bldg-eng', status: 'normal', lastCollected: 'Today 06:30' },
  { id: 'bin-04', code: 'WB-UNION-PLAZA-1', category: 'compost', fillLevel: 88, coordinates: [37.4278, -122.1712], location: 'Student Union Dining Terrace', buildingId: 'bldg-union', status: 'near_full', lastCollected: 'Yesterday 18:00' },
  { id: 'bin-05', code: 'WB-UNION-PLAZA-2', category: 'recycle', fillLevel: 94, coordinates: [37.4278, -122.1711], location: 'Student Union Dining Terrace', buildingId: 'bldg-union', status: 'full', lastCollected: 'Yesterday 18:00' },
  { id: 'bin-06', code: 'WB-UNION-PLAZA-3', category: 'landfill', fillLevel: 78, coordinates: [37.4278, -122.1710], location: 'Student Union Dining Terrace', buildingId: 'bldg-union', status: 'near_full', lastCollected: 'Yesterday 18:00' },
  { id: 'bin-07', code: 'WB-LIB-COURT-1', category: 'recycle', fillLevel: 30, coordinates: [37.4272, -122.1672], location: 'Green Library Courtyard', buildingId: 'bldg-lib', status: 'normal', lastCollected: 'Today 07:15' },
  { id: 'bin-08', code: 'WB-LIB-COURT-2', category: 'ewaste', fillLevel: 25, coordinates: [37.4271, -122.1673], location: 'Green Library Courtyard (Tech Hub)', buildingId: 'bldg-lib', status: 'normal', lastCollected: '3 days ago' },
  { id: 'bin-09', code: 'WB-RES-NORTH-1', category: 'compost', fillLevel: 55, coordinates: [37.4318, -122.1670], location: 'North Residence Quad', buildingId: 'bldg-res-n', status: 'normal', lastCollected: 'Today 08:00' },
  { id: 'bin-10', code: 'WB-RES-NORTH-2', category: 'recycle', fillLevel: 62, coordinates: [37.4319, -122.1669], location: 'North Residence Quad', buildingId: 'bldg-res-n', status: 'normal', lastCollected: 'Today 08:00' },
  { id: 'bin-11', code: 'WB-RES-SOUTH-1', category: 'landfill', fillLevel: 82, coordinates: [37.4248, -122.1704], location: 'South Heritage Lawn', buildingId: 'bldg-res-s', status: 'near_full', lastCollected: 'Yesterday 14:00' },
  { id: 'bin-12', code: 'WB-SPORT-01', category: 'recycle', fillLevel: 45, coordinates: [37.4262, -122.1652], location: 'Athletics Stadium Gates', buildingId: 'bldg-sport', status: 'normal', lastCollected: 'Today 09:00' },
];
